...
<body>
    ...
    <section id="header">
        <a href="{{route('home')}}"><img src="" alt="" class="logo"></a>
            <div>
                <ul id="navbar">
                    <li><a class="active a" href="{{route('home')}}">Home</a></li>
    ...
    <!-- Hero Section -->
        <section id="hero">
            ...
            <p>Enjoy</p>
            <a href="{{route('products-page')}}">Shop Now</a>
        </section>
    <!-- End Of Hero Section -->

    <!-- Products Section -->
        <section id="product1" class="section-p1">
            <h2 class="display-4" style="font-weight: 700">Featured Products</h2>
    ...
    <!-- Latest Products Section -->
        <section id="product1" class="section-p1">
            <h2 class="display-4" style="font-weight: 700">New Arrivals</h2>
            <p>Summer colelection New Modern Design</p>
            <div class="pro-container">
                @foreach ($products as $product)
                    <div class="pro">
